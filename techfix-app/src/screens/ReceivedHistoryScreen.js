// E:\study\techfix\techfix-app\src\screens\ReceivedHistoryScreen.js
...
export default function ReceivedHistoryScreen({ navigation }) {
    ...
    const fetchReceivedHistory = async () => {
        try {
            setLoading(true);
            const response = await client.get('/stock-out/received-history/');
        ...
        <View style={styles.itemCard}>
            ...
            <View style={styles.cardBody}>
                ...
                {item.ordered_by_name && (
                    <View style={styles.infoRow}>
                        ...
                        <Text style={styles.infoTextBold}>
                            Ordered by: {item.ordered_by_name}
                        </Text>
                    </View>
                )}
                ...
                <View style={styles.infoRow}>
                    ...
                    <Text style={styles.infoTextBold}>
                        Received by: {item.received_by_name || 'Admin'}
                    </Text>
                </View>
        ...
        return (
            <View style={[styles.container, { paddingTop: insets.top }]}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>Received History</Text>
                    <View style={{ width: 24 }} />
                </View>
        ...
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <View style={styles.infoBar}>
                ...
                <Text style={styles.infoBarText}>
                    Total Received: {receivedHistory.length}
                </Text>
            </View>
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <View style={styles.emptyContainer}>
                        ...
                        <Text style={styles.emptyText}>No received history</Text>
                        <Text style={styles.emptySubtext}>
                            Received history will appear here
                        </Text>
                    </View>
                }
            />
