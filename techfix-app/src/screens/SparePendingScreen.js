    ...
    <View style={styles.complaintCard}>
      ...
      <View style={styles.detailsGrid}>
        ...
        <View style={styles.detailItem}>
          ...
          <Text style={styles.detailValue}>{item.product_code}</Text>
        </View>
        ...
        <View style={styles.detailItem}>
          ...
          <Text style={styles.detailValue}>{item.no_of_spares}</Text>
        </View>
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <FlatList
        ...
        keyExtractor={(item, index) => `${item.complaint_no}_${index}`}
